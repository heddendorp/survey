...
@stop
@section('helptext')
Hier können Sie den internen sowie externen Namen des Fragebogens ändern. Nur der externe Name ist für die Teilnehmer einsehbar.
Des weiteren könenn sie die Texte für die Mails festlegen, welche an die Teilnehmer in unterschieldichen Phasen der Umfrage geschickt werden können.
@stop
@section('content')
